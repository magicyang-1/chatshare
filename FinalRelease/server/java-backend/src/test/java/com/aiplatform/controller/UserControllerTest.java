...
public class UserControllerTest {
    ...
    @Test
    @WithMockUser(username = "test@example.com")
    public void testGetSupportChat_withSupportSenderInfo() throws Exception {
        // 模拟当前用户
        User user = new User();
        user.setId(1L);
        user.setEmail("test@example.com");
        ...
        supportUser.setId(2L);
        supportUser.setUsername("support1");
        supportUser.setEmail("support1@example.com");
        supportUser.setRole(User.UserRole.support);

        // 模拟来自客服的消息
        SupportChat chat = new SupportChat();
        chat.setId(1L);
        chat.setContent("您好，我是客服，有什么可以帮助您的吗？");
        chat.setSenderType(SupportChat.SenderType.SUPPORT);
        chat.setIsRead(false);
        chat.setCreatedAt(LocalDateTime.now());
        chat.setUserId(1L);
        ...
        mockMvc.perform(get("/user/support/chat")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].content").value("您好，我是客服，有什么可以帮助您的吗？"))
                .andExpect(jsonPath("$[0].fromUser").exists())
                .andExpect(jsonPath("$[0].fromUser.id").value(2))
                .andExpect(jsonPath("$[0].fromUser.username").value("support1"))
                .andExpect(jsonPath("$[0].fromUser.email").value("support1@example.com"))
                .andExpect(jsonPath("$[0].fromUser.role").value("support"));
        
        System.out.println("✅ 客服发送者信息测试通过");
    }

    @Test
    @WithMockUser(username = "test@example.com")
    public void testGetSupportChat_withUserSenderInfo() throws Exception {
        // 模拟当前用户
        User user = new User();
        user.setId(1L);
        user.setEmail("test@example.com");
        ...
        SupportChat chat = new SupportChat();
        chat.setId(1L);
        chat.setContent("我需要帮助");
        chat.setSenderType(SupportChat.SenderType.USER);
        chat.setIsRead(false);
        chat.setCreatedAt(LocalDateTime.now());
        chat.setUserId(1L);
        chat.setSupportId(2L);
        ...
        mockMvc.perform(get("/user/support/chat")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].content").value("我需要帮助"))
                .andExpect(jsonPath("$[0].fromUser").exists())
                .andExpect(jsonPath("$[0].fromUser.id").value(1))
                .andExpect(jsonPath("$[0].fromUser.username").value("testuser"))
                .andExpect(jsonPath("$[0].fromUser.email").value("test@example.com"))
                .andExpect(jsonPath("$[0].fromUser.role").value("user"));
        
        System.out.println("✅ 用户发送者信息测试通过");
    }

    @Test
    @WithMockUser(username = "test@example.com")
    public void testGetSupportChat_supportSenderNotFound() throws Exception {
        // 模拟当前用户
        User user = new User();
        user.setId(1L);
        user.setEmail("test@example.com");
        ...
        chat.setCreatedAt(LocalDateTime.now());
        chat.setUserId(1L);
        chat.setSupportId(999L); // 不存在的客服ID
        ...
        mockMvc.perform(get("/user/support/chat")
                ...
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].content").value("客服消息"))
                .andExpect(jsonPath("$[0].fromUser").doesNotExist()); // 客服不存在时不应该有fromUser字段
        
        System.out.println("✅ 客服发送者不存在测试通过");
    }

    @Test
    @WithMockUser(username = "test@example.com")
    public void testGetSupportChat_supportIdNull() throws Exception {
        // 模拟当前用户
        User user = new User();
        user.setId(1L);
        user.setEmail("test@example.com");
        ...
        chat.setCreatedAt(LocalDateTime.now());
        chat.setUserId(1L);
        chat.setSupportId(null); // supportId为null
        ...
        mockMvc.perform(get("/user/support/chat")
                ...
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].content").value("客服消息"))
                .andExpect(jsonPath("$[0].fromUser").doesNotExist()); // supportId为null时不应该有fromUser字段
        
        System.out.println("✅ 客服ID为空测试通过");
    }

    @Test
    @WithMockUser(username = "test@example.com")
    public void testGetSupportChat_mixedSenderTypes() throws Exception {
        // 模拟当前用户
        User user = new User();
        user.setId(1L);
        user.setEmail("test@example.com");
        ...
        // 模拟混合消息：用户消息和客服消息
        SupportChat userChat = new SupportChat();
        userChat.setId(1L);
        userChat.setContent("我需要帮助");
        userChat.setSenderType(SupportChat.SenderType.USER);
        userChat.setIsRead(false);
        userChat.setCreatedAt(LocalDateTime.now());
        userChat.setUserId(1L);
        userChat.setSupportId(2L);

        SupportChat supportChat = new SupportChat();
        supportChat.setId(2L);
        supportChat.setContent("您好，我是客服，有什么可以帮助您的吗？");
        supportChat.setSenderType(SupportChat.SenderType.SUPPORT);
        supportChat.setIsRead(false);
        supportChat.setCreatedAt(LocalDateTime.now());
        supportChat.setUserId(1L);
        supportChat.setSupportId(2L);

        List<SupportChat> chats = Arrays.asList(userChat, supportChat);
        ...
        mockMvc.perform(get("/user/support/chat")
                ...
                .andExpect(jsonPath("$[0].fromUser.role").value("user"))
                // 第二条消息（客服消息）
                .andExpect(jsonPath("$[1].content").value("您好，我是客服，有什么可以帮助您的吗？"))
                .andExpect(jsonPath("$[1].fromUser.id").value(2))
                .andExpect(jsonPath("$[1].fromUser.username").value("support1"))
                .andExpect(jsonPath("$[1].fromUser.role").value("support"));
        
        System.out.println("✅ 混合发送者类型测试通过");
    }
