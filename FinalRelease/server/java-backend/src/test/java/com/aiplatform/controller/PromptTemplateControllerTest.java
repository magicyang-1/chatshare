...
public class PromptTemplateControllerTest {
    ...
    public void testGetTemplates_byCategory() throws Exception {
        ...
        Mockito.when(promptTemplateService.getTemplatesByCategory(1L, 0, 20))
                .thenReturn(page);
        Mockito.when(promptTemplateService.convertToDTO(anyList(), any()))
...
//    }
    ...
    // ========== JWT Token解析和用户查找相关测试 ==========

    @Test
    public void testGetTemplates_withValidTokenAndUser() throws Exception {
        // 模拟有效的JWT Token和用户
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        // 模拟模板数据
        List<PromptTemplate> templates = Arrays.asList(
            createTemplate(1L, "测试模板1", 1L),
            createTemplate(2L, "测试模板2", 1L)
        );
        Page<PromptTemplate> page = new PageImpl<>(templates, PageRequest.of(0, 20), 2);
        
        Mockito.when(promptTemplateService.getTemplatesByCategory(null, 0, 20))
                .thenReturn(page);
        Mockito.when(promptTemplateService.convertToDTO(anyList(), eq(1L)))
                .thenReturn(Arrays.asList(
                    createTemplateDTO(1L, "测试模板1"),
                    createTemplateDTO(2L, "测试模板2")
                ));
        ...
        System.out.println("✅ 获取模板（有效Token和用户）测试通过");
    }

    @Test
    public void testGetTemplates_withValidTokenButUserNotFound() throws Exception {
        // 模拟有效的JWT Token但用户不存在
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
        ...
        // 模拟模板数据（游客模式）
        List<PromptTemplate> templates = Arrays.asList(
            createTemplate(1L, "游客模板1", 1L),
            createTemplate(2L, "游客模板2", 1L)
        );
        Page<PromptTemplate> page = new PageImpl<>(templates, PageRequest.of(0, 20), 2);
        
        Mockito.when(promptTemplateService.getTemplatesByCategory(null, 0, 20))
                .thenReturn(page);
        Mockito.when(promptTemplateService.convertToDTO(anyList(), eq(null)))
                .thenReturn(Arrays.asList(
                    createTemplateDTO(1L, "游客模板1"),
                    createTemplateDTO(2L, "游客模板2")
                ));
        ...
        System.out.println("✅ 获取模板（有效Token但用户不存在）测试通过");
    }

    @Test
    public void testGetTemplates_withInvalidToken() throws Exception {
        // 模拟无效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-token"))
        ...
        System.out.println("✅ 获取模板（无效Token）测试通过");
    }

    @Test
    public void testGetTemplates_withShortToken() throws Exception {
        // 模拟过短的token（可能导致substring异常）
        Mockito.when(jwtTokenProvider.getEmailFromToken("short"))
                .thenThrow(new StringIndexOutOfBoundsException("String index out of range: 7"));
        ...
        System.out.println("✅ 获取模板（过短Token）测试通过");
    }

    @Test
    public void testGetTemplates_withNullToken() throws Exception {
        // 模拟null token
        Mockito.when(jwtTokenProvider.getEmailFromToken(null))
                .thenThrow(new NullPointerException("Token cannot be null"));
        ...
        System.out.println("✅ 获取模板（空Token）测试通过");
    }

    @Test
    public void testGetTemplates_withUserServiceException() throws Exception {
        // 模拟有效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        System.out.println("✅ 获取模板（用户服务异常）测试通过");
    }

    @Test
    public void testGetTemplates_withoutAuthorizationHeader() throws Exception {
        // 不提供Authorization header，测试游客模式
        ...
        System.out.println("✅ 获取模板（无Authorization头）测试通过");
    }

    @Test
    public void testGetTemplates_withMalformedAuthorizationHeader() throws Exception {
        // 模拟格式错误的Authorization header（不是Bearer格式）
        ...
        System.out.println("✅ 获取模板（格式错误的Authorization头）测试通过");
    }

    // ========== 精选模板JWT Token解析相关测试 ==========

    @Test
    public void testGetFeaturedTemplates_withValidTokenAndUser() throws Exception {
        // 模拟有效的JWT Token和用户
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        // 模拟精选模板数据
        List<PromptTemplate> templates = Arrays.asList(
            createTemplate(1L, "精选模板1", 1L),
            createTemplate(2L, "精选模板2", 1L)
        );
        ...
        Mockito.when(promptTemplateService.convertToDTO(anyList(), eq(1L)))
                .thenReturn(Arrays.asList(
                    createTemplateDTO(1L, "精选模板1"),
                    createTemplateDTO(2L, "精选模板2")
                ));
        ...
        System.out.println("✅ 获取精选模板（有效Token和用户）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withValidTokenButUserNotFound() throws Exception {
        // 模拟有效的JWT Token但用户不存在
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("nonexistent@example.com");
        ...
        System.out.println("✅ 获取精选模板（有效Token但用户不存在）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withInvalidToken() throws Exception {
        // 模拟无效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-token"))
                .thenThrow(new RuntimeException("Invalid token format"));
        ...
        System.out.println("✅ 获取精选模板（无效Token）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withShortToken() throws Exception {
        // 模拟过短的token（可能导致substring异常）
        Mockito.when(jwtTokenProvider.getEmailFromToken("short"))
                .thenThrow(new StringIndexOutOfBoundsException("String index out of range: 7"));
        ...
        System.out.println("✅ 获取精选模板（过短Token）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withNullToken() throws Exception {
        // 模拟null token
        Mockito.when(jwtTokenProvider.getEmailFromToken(null))
                .thenThrow(new NullPointerException("Token cannot be null"));
        ...
        System.out.println("✅ 获取精选模板（空Token）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withUserServiceException() throws Exception {
        // 模拟有效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        System.out.println("✅ 获取精选模板（用户服务异常）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withoutAuthorizationHeader() throws Exception {
        // 不提供Authorization header，测试游客模式
        ...
        System.out.println("✅ 获取精选模板（无Authorization头）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withMalformedAuthorizationHeader() throws Exception {
        // 模拟格式错误的Authorization header（不是Bearer格式）
        ...
        System.out.println("✅ 获取精选模板（格式错误的Authorization头）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withJwtTokenExpired() throws Exception {
        // 模拟JWT token过期
        Mockito.when(jwtTokenProvider.getEmailFromToken("expired-token"))
        ...
        System.out.println("✅ 获取精选模板（Token过期）测试通过");
    }

    @Test
    public void testGetFeaturedTemplates_withJwtTokenSignatureInvalid() throws Exception {
        // 模拟JWT token签名无效
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-signature-token"))
        ...
        System.out.println("✅ 获取精选模板（Token签名无效）测试通过");
    }

    // ========== 热门模板JWT Token解析相关测试 ==========

    @Test
    public void testGetPopularTemplates_withValidTokenAndUser() throws Exception {
        // 模拟有效的JWT Token和用户
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        // 模拟热门模板数据
        List<PromptTemplate> templates = Arrays.asList(
            createTemplate(1L, "热门模板1", 1L),
            createTemplate(2L, "热门模板2", 1L)
        );
        ...
        Mockito.when(promptTemplateService.convertToDTO(anyList(), eq(1L)))
                .thenReturn(Arrays.asList(
                    createTemplateDTO(1L, "热门模板1"),
                    createTemplateDTO(2L, "热门模板2")
                ));
        ...
        System.out.println("✅ 获取热门模板（有效Token和用户）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withValidTokenButUserNotFound() throws Exception {
        // 模拟有效的JWT Token但用户不存在
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("nonexistent@example.com");
        ...
        System.out.println("✅ 获取热门模板（有效Token但用户不存在）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withInvalidToken() throws Exception {
        // 模拟无效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-token"))
                .thenThrow(new RuntimeException("Invalid token format"));
        ...
        System.out.println("✅ 获取热门模板（无效Token）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withShortToken() throws Exception {
        // 模拟过短的token（可能导致substring异常）
        Mockito.when(jwtTokenProvider.getEmailFromToken("short"))
                .thenThrow(new StringIndexOutOfBoundsException("String index out of range: 7"));
        ...
        System.out.println("✅ 获取热门模板（过短Token）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withNullToken() throws Exception {
        // 模拟null token
        Mockito.when(jwtTokenProvider.getEmailFromToken(null))
                .thenThrow(new NullPointerException("Token cannot be null"));
        ...
        System.out.println("✅ 获取热门模板（空Token）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withUserServiceException() throws Exception {
        // 模拟有效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        System.out.println("✅ 获取热门模板（用户服务异常）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withoutAuthorizationHeader() throws Exception {
        // 不提供Authorization header，测试游客模式
        ...
        System.out.println("✅ 获取热门模板（无Authorization头）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withMalformedAuthorizationHeader() throws Exception {
        // 模拟格式错误的Authorization header（不是Bearer格式）
        ...
        System.out.println("✅ 获取热门模板（格式错误的Authorization头）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withJwtTokenExpired() throws Exception {
        // 模拟JWT token过期
        Mockito.when(jwtTokenProvider.getEmailFromToken("expired-token"))
                .thenThrow(new RuntimeException("Token has expired"));
        ...
        System.out.println("✅ 获取热门模板（Token过期）测试通过");
    }

    @Test
    public void testGetPopularTemplates_withJwtTokenSignatureInvalid() throws Exception {
        // 模拟JWT token签名无效
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-signature-token"))
                .thenThrow(new RuntimeException("Invalid JWT signature"));
        ...
        System.out.println("✅ 获取热门模板（Token签名无效）测试通过");
    }

    // ========== 模板详情JWT Token解析相关测试 ==========

    @Test
    public void testGetTemplateById_withValidTokenAndUser() throws Exception {
        // 模拟有效的JWT Token和用户
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        // 模拟模板详情数据
        PromptTemplate template = createTemplate(1L, "测试模板详情", 1L);
        
        Mockito.when(promptTemplateService.getTemplateById(eq(1L)))
                .thenReturn(Optional.of(template));
        Mockito.when(promptTemplateService.convertToDTO(anyList(), eq(1L)))
                .thenReturn(Arrays.asList(createTemplateDTO(1L, "测试模板详情")));

        mockMvc.perform(MockMvcRequestBuilders.get("/prompt-templates/1")
                        .header("Authorization", "Bearer valid-token"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
                .andExpect(jsonPath("$.template.title").value("测试模板详情"));

        System.out.println("✅ 获取模板详情（有效Token和用户）测试通过");
    }

    @Test
    public void testGetTemplateById_withValidTokenButUserNotFound() throws Exception {
        // 模拟有效的JWT Token但用户不存在
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("nonexistent@example.com");
        ...
        System.out.println("✅ 获取模板详情（有效Token但用户不存在）测试通过");
    }

    @Test
    public void testGetTemplateById_withInvalidToken() throws Exception {
        // 模拟无效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-token"))
                .thenThrow(new RuntimeException("Invalid token format"));
        ...
        System.out.println("✅ 获取模板详情（无效Token）测试通过");
    }

    @Test
    public void testGetTemplateById_withShortToken() throws Exception {
        // 模拟过短的token（可能导致substring异常）
        Mockito.when(jwtTokenProvider.getEmailFromToken("short"))
                .thenThrow(new StringIndexOutOfBoundsException("String index out of range: 7"));
        ...
        System.out.println("✅ 获取模板详情（过短Token）测试通过");
    }

    @Test
    public void testGetTemplateById_withNullToken() throws Exception {
        // 模拟null token
        Mockito.when(jwtTokenProvider.getEmailFromToken(null))
                .thenThrow(new NullPointerException("Token cannot be null"));
        ...
        System.out.println("✅ 获取模板详情（空Token）测试通过");
    }

    @Test
    public void testGetTemplateById_withUserServiceException() throws Exception {
        // 模拟有效的JWT Token
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        System.out.println("✅ 获取模板详情（用户服务异常）测试通过");
    }

    @Test
    public void testGetTemplateById_withoutAuthorizationHeader() throws Exception {
        // 不提供Authorization header，测试游客模式
        ...
        System.out.println("✅ 获取模板详情（无Authorization头）测试通过");
    }

    @Test
    public void testGetTemplateById_withMalformedAuthorizationHeader() throws Exception {
        // 模拟格式错误的Authorization header（不是Bearer格式）
        ...
        System.out.println("✅ 获取模板详情（格式错误的Authorization头）测试通过");
    }

    @Test
    public void testGetTemplateById_withJwtTokenExpired() throws Exception {
        // 模拟JWT token过期
        Mockito.when(jwtTokenProvider.getEmailFromToken("expired-token"))
                .thenThrow(new RuntimeException("Token has expired"));
        ...
        System.out.println("✅ 获取模板详情（Token过期）测试通过");
    }

    @Test
    public void testGetTemplateById_withJwtTokenSignatureInvalid() throws Exception {
        // 模拟JWT token签名无效
        Mockito.when(jwtTokenProvider.getEmailFromToken("invalid-signature-token"))
                .thenThrow(new RuntimeException("Invalid JWT signature"));
        ...
        System.out.println("✅ 获取模板详情（Token签名无效）测试通过");
    }

    @Test
    public void testGetTemplateById_withTemplateNotFound() throws Exception {
        // 模拟有效的JWT Token和用户
        Mockito.when(jwtTokenProvider.getEmailFromToken("valid-token"))
                .thenReturn("test@example.com");
        ...
        System.out.println("✅ 获取模板详情（模板不存在）测试通过");
    }
} 